...
$CertificaatMenuTree = @{
    ...
    Items = @(
        ...
        @{ Label='Backup / Restore'; Key='backup'; Type='submenu'; Items=@(@{ Label='Create backup'; Key='backup-create'; Type='action' },@{ Label='Restore from backup'; Key='backup-restore'; Type='action' },@{Key='back';Label='.. Back';Type='back'})},

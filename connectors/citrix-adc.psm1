...
function Invoke-CitrixRest {
    ...
    if ($skip) { Write-CertificaatLog -Level 'WARN' -Message 'CERTIFICAAT_SKIP_TLS_CHECK is enabled for Citrix connector.' }
...
function Invoke-CitrixAdcProbe { param([hashtable]$Context)
    Connect-CitrixNitro -Context $Context
...
function Invoke-CitrixAdcDeploy { param([hashtable]$Context)
...
function Invoke-CitrixAdcBind { param([hashtable]$Context)
...
function Invoke-CitrixAdcActivate { param([hashtable]$Context)
...
function Invoke-CitrixAdcVerify { param([hashtable]$Context)
...
function Invoke-CitrixAdcRollback { param([hashtable]$Context)
...
Export-ModuleMember -Function Invoke-CitrixAdcProbe,Invoke-CitrixAdcDeploy,Invoke-CitrixAdcBind,Invoke-CitrixAdcActivate,Invoke-CitrixAdcVerify,Invoke-CitrixAdcRollback

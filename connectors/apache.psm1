...
function Invoke-ApacheProbe { param([hashtable]$Context) Invoke-StubProbe -Context $Context -Connector 'apache' }
function Invoke-ApacheDeploy { param([hashtable]$Context) Invoke-StubDeploy -Context $Context -Connector 'apache' }
function Invoke-ApacheBind { param([hashtable]$Context) Invoke-StubBind -Context $Context -Connector 'apache' }
function Invoke-ApacheActivate { param([hashtable]$Context) Invoke-StubActivate -Context $Context -Connector 'apache' }
function Invoke-ApacheVerify { param([hashtable]$Context) Invoke-StubVerify -Context $Context -Connector 'apache' }
function Invoke-ApacheRollback { param([hashtable]$Context) Invoke-StubRollback -Context $Context -Connector 'apache' }

Export-ModuleMember -Function Invoke-ApacheProbe,Invoke-ApacheDeploy,Invoke-ApacheBind,Invoke-ApacheActivate,Invoke-ApacheVerify,Invoke-ApacheRollback

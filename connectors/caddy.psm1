...
function Invoke-CaddyProbe { param([hashtable]$Context) Invoke-StubProbe -Context $Context -Connector 'caddy' }
function Invoke-CaddyDeploy { param([hashtable]$Context) Invoke-StubDeploy -Context $Context -Connector 'caddy' }
function Invoke-CaddyBind { param([hashtable]$Context) Invoke-StubBind -Context $Context -Connector 'caddy' }
function Invoke-CaddyActivate { param([hashtable]$Context) Invoke-StubActivate -Context $Context -Connector 'caddy' }
function Invoke-CaddyVerify { param([hashtable]$Context) Invoke-StubVerify -Context $Context -Connector 'caddy' }
function Invoke-CaddyRollback { param([hashtable]$Context) Invoke-StubRollback -Context $Context -Connector 'caddy' }

Export-ModuleMember -Function Invoke-CaddyProbe,Invoke-CaddyDeploy,Invoke-CaddyBind,Invoke-CaddyActivate,Invoke-CaddyVerify,Invoke-CaddyRollback
